...
int	get_integer_digit_count(double value)
{
	int count;
...
char get_integer_digit_at(double value, int index)
{
	while (index > 0)
	{
		value /= 10;
...
long double move_integer_part(long double value, int digit_count)
{
	while (digit_count > 0)
	{
		value /= 10;
...
void get_integer_part(long double value, char *buffer)
{
	int digit_count;
	int i;
	char digit;
	...
	i = 0;
	digit_count = get_integer_digit_count(value);
	printf("digit_count: %d\n", digit_count);
	printf("%.50Lg\n", value);
	long double divisor = powl(10, digit_count);
	printf("max divisor: %.50Lg\n", divisor);
	tmp = value / divisor;
	printf("%.50Lg\n", divisor);
...
//	while (i < digit_count)
//	{
//		digit = get_integer_digit_at(value, digit_count - i - 1);
//		buffer[i] = '0' + digit;
//		printf("%c")
//		long double tmp = powl(10, digit_count - i - 1);
//		tmp *= digit;
//		value -= tmp;
//		i++;
//	}
